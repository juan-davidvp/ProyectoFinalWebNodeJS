...
router.post('/logout', AuthController.logout); //Con esto le decimos a la app que si el usuario hace un post a la ruta /logout, ejecute la funcion logout del controlador AuthController.
